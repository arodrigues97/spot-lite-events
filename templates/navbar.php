...
<nav class="navbar navbar-dark navbar-expand-lg">
    ...
    <div class="navbar-collapse collapse justify-content-between align-items-center w-100" id="collapsingNavbar2">
        ...
        <ul class="nav navbar-nav flex-row justify-content-center flex-nowrap icons">
            <li class="nav-item"><a class="nav-link" href="https://www.facebook.com/SpotliteEvents/"><i class="fab fa-facebook"></i></a> </li>
            <li class="nav-item"><a class="nav-link" href="https://www.linkedin.com/company/spotlite-events-ptr/about/"><i class="fab fa-linkedin"></i></a> </li>
            <li class="nav-item"><a class="nav-link" href="http://www.instagram.com/spotliteevents"><i class="fab fa-instagram "></i></a> </li>
        </ul>
    </div>
</nav>
